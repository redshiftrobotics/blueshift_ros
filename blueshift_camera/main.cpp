...
int main(int argc, char *argv[])
{
    ...
    if (!data.pipeline || !data.source || !data.audioconvert || !data.resample || !data.audiosink || !data.videoconvert || !data.audioconvert)
    {
    ...
    gst_bin_add_many(GST_BIN(data.pipeline), data.source, data.audioconvert, data.resample, data.audiosink, data.videoconvert, data.videosink, NULL);
